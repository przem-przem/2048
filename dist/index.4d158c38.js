...
parcelHelpers.export(exports, "MAX_TILE", ()=>MAX_TILE
);
...
/* Start the game when clicking */ tapToStart.addEventListener("click", function() {
    ...
    let newTile = new _tileJsDefault.default(gameBoard);
    MAX_TILE = newTile.value;
    grid.randomEmptyCell().tile = newTile;
    newTile = new _tileJsDefault.default(gameBoard);
...
class Cell {
    ...
    mergeTiles() {
        ...
        console.log(_main2Js.MAX_TILE);
        const newMax = Math.max(_main2Js.MAX_TILE, this.tile.value);
        console.log(newMax);
        _main2Js.maxtile.innerHTML = `Max tile: ${newMax}`;
        if (typeof this.tile.value == "number") {
            updateScore(this.tile.value);
            updateMaxtile();
        }
        if (this.tile.value == 1024 * _main2Js.baseNumber) _endgameHandlerJs.endGame(true);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./EndgameHandler.js":"9H4G8","./main2.js":"1tWgD"}],"gkKU3":[function(require,module,exports) {
...
},{}],"9H4G8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const endGame = (outcome)=>{
    if (outcome) _main2Js.endGameTitle.innerHTML = "You win :)";
    else _main2Js.endGameTitle.innerHTML = "You lose :(";
    _main2Js.endGameBoard.classList.remove(_main2Js.hiddenClass);
...
},{"./main2.js":"1tWgD","./Cell.js":"6LzwN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kElux":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _main2Js = require("./main2.js");
const tileColors = [
...
const handlerInput = async (e)=>{
    ...
    if (!_main2Js.endGameBoard.classList.contains(_main2Js.hiddenClass)) {
        _endgameHandlerJs.endGameScoreUpdate();
        return;
    }
    const newTile = new _tileJsDefault.default(_main2Js.gameBoard);
    MAX_TILE = Math.max(_main2Js.MAX_TILE, newTile.value);
    _main2Js.maxtile.innerHTML = `Max tile: ${_main2Js.MAX_TILE}`;
...
},{"./Grid.js":"irQ6N","./Tile.js":"kElux","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./main2.js":"1tWgD","./EndgameHandler.js":"9H4G8","./Cell.js":"6LzwN"}],"8wGYB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
