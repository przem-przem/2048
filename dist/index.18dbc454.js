...
const setupInput = ()=>{
    window.addEventListener("keydown", handlerInput, {
        once: true
    });
};
let touches = [
...
const determineTouchDirection = ()=>{
    ...
    /* Distance in X direction */ const distanceX = touches[0][1] - touches[0][0];
    console.log(distanceX);
    /* Distance in Y direction */ const distanceY = touches[1][1] - touches[1][0];
